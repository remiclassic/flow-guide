...
import { reorderModulesAction } from '@/lib/admin/course-actions';
import { Button } from '@/components/ui/button';

export function ModuleOrderControls({
  courseSlug,
  modules,
}: {
  courseSlug: string;
  modules: { id: number; titleEn: string }[];
}) {
  ...
  const labels = new Map(modules.map((m) => [m.id, m.titleEn]));
