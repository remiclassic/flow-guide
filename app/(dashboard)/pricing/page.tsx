    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="grid md:grid-cols-2 gap-8 max-w-xl mx-auto">
        <PricingCard
          ...
          features={[
            'Full Glow Flow curriculum access',
        ...
        <PricingCard
          ...
          features={[
            ...
            'Priority onboarding lane',
            'Early drops for AI coaching labs',
          ]}
    ...
    <div className="pt-6">
      ...
      {!priceId ? (
        <p className="mt-3 text-xs text-muted-foreground">
          Connect Stripe + run <code className="rounded bg-gray-100 px-1">pnpm db:seed</code>{' '}
          to wire live price IDs.
        </p>
      ) : null}
    </div>
  );
