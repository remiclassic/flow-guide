    ...
    <DropdownMenu open={isMenuOpen} onOpenChange={setIsMenuOpen}>
      ...
      <DropdownMenuContent align="end" className="flex flex-col gap-1">
        <DropdownMenuItem className="cursor-pointer">
          <NextLink href="/dashboard/courses" className="flex w-full items-center">
            <BookOpen className="mr-2 h-4 w-4" />
            <span>{t('courses')}</span>
          </NextLink>
        </DropdownMenuItem>
        <DropdownMenuItem className="cursor-pointer">
          <NextLink href="/dashboard/billing" className="flex w-full items-center">
            <CreditCard className="mr-2 h-4 w-4" />
            <span>{t('billing')}</span>
          </NextLink>
        </DropdownMenuItem>
        <DropdownMenuItem className="cursor-pointer">
          <NextLink href="/dashboard" className="flex w-full items-center">
            <Home className="mr-2 h-4 w-4" />
            <span>{t('learningHome')}</span>
          </NextLink>
        </DropdownMenuItem>
        <DropdownMenuItem className="cursor-pointer">
          <NextLink href="/dashboard/team" className="flex w-full items-center">
